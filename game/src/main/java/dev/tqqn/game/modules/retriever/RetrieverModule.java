package dev.tqqn.game.modules.retriever;

import dev.tqqn.game.BingoMain;
import dev.tqqn.game.modules.AbstractModule;
import dev.tqqn.game.modules.retriever.listeners.ChatListener;
import dev.tqqn.game.modules.retriever.listeners.QuitListener;
import dev.tqqn.game.modules.retriever.objects.AbstractRetriever;
import dev.tqqn.game.modules.retriever.objects.types.DoubleRetriever;
import dev.tqqn.game.modules.retriever.objects.types.IntRetriever;
import dev.tqqn.game.modules.retriever.objects.types.StringRetriever;
