package dev.tqqn.common.menu.framework.objects;
...
import dev.tqqn.common.utils.ItemBuilder;
...
public abstract class Menu implements InventoryHolder {
    ...
    public void handleClose() {
        Bukkit.getScheduler().runTaskLater(PluginProvider.get().getPlugin(), () -> viewer.closeInventory(), 1L);
        onClose(viewer);
    }
