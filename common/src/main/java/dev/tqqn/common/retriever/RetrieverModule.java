package dev.tqqn.common.retriever;

import dev.tqqn.common.modular.AbstractModule;
import dev.tqqn.common.modular.ModuleManager;
import dev.tqqn.common.retriever.listeners.ChatListener;
import dev.tqqn.common.retriever.listeners.QuitListener;
import dev.tqqn.common.retriever.objects.AbstractRetriever;
import dev.tqqn.common.retriever.objects.types.DoubleRetriever;
import dev.tqqn.common.retriever.objects.types.IntRetriever;
import dev.tqqn.common.retriever.objects.types.StringRetriever;
...
public final class RetrieverModule extends AbstractModule {
    ...
    public RetrieverModule(ModuleManager bingoMain) {
